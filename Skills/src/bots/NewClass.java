...
//            while(m>0 && availablePirates.size()!=0) {
...
//                }
//                else {
//                    if(t1.Pirate.getLocation().col > 3) {
...
//            }
//        }
//        for (Pirate my : game.myDrunkPirates()) {
//            if(game.distance(t1.Pirate, my) < 2 && game.distance(my, t1.TempDestination) < 2){
//                if(t1.TempDestination.col != my.getLocation().col) {
//                    if(t1.Pirate.getLocation().row > 3) {
//                        loc = new Location(t1.Pirate.getLocation().row-3, t1.Pirate.getLocation().col);
//                    } else {
//                        loc = new Location(t1.Pirate.getLocation().row+3, t1.Pirate.getLocation().col);
